...
kexperimento   <- "KA8440_dataset_FE_canaritos_v1_it35"

ksemilla_primos  <-  102191
ksemillerio  <- 20

kmax_bin           <-    31
klearning_rate     <-     0.010005921589382
knum_iterations    <-   3677
knum_leaves        <-   131
kmin_data_in_leaf  <-  4997
kfeature_fraction  <-     0.541408095144518
