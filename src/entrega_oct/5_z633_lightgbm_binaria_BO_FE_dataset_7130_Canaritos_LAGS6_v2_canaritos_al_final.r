...
kdataset       <- "./exp/FE8150/dataset_7130_Canaritos_LAGS6_v2_canaritos_al_final.csv.gz"    # El dataset generado con Feature Engineering
ksemilla_azar  <- 102191  #Aqui poner la propia semilla
kexperimento   <- "HT6330_dataset_7130_v1"
