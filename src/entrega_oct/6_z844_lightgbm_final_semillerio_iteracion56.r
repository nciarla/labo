...
kexperimento   <- "KA8440_dataset_FE_canaritos_v1_it56"

ksemilla_primos  <-  102191
ksemillerio  <- 20

kmax_bin           <-    31
klearning_rate     <-     0.0100293484437456
knum_iterations    <-   5026
knum_leaves        <-   968
kmin_data_in_leaf  <-  7837
kfeature_fraction  <-     0.3052397949179
