...
kdataset       <- "./datasets/dataset_7130_Canaritos_LAGS6_v2_canaritos_al_final.csv.gz"
ksemilla_azar  <- 102191  #Aqui poner la propia semilla
ktraining      <- c( 202007,202008,202009,202010,202011,202012,202101 )   #periodos en donde entreno
kfuture        <- c( 202103 )   #periodo donde aplico el modelo final


kexperimento   <- "KA8440_dataset_FE_canaritos_v1_it32"

ksemilla_primos  <-  102191
ksemillerio  <- 20

kmax_bin           <-    31
klearning_rate     <-     0.0105632263407223
knum_iterations    <-   4282
knum_leaves        <-   350
kmin_data_in_leaf  <-  6648
kfeature_fraction  <-     0.334674914960034
...
for( semilla  in  ksemillas )
{
  ...
  #calculo el ranking
  ## hace el ranking.. si hay empate los ordena random pq necesito q estén consecutivos ordenados 
